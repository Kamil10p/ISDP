...
spawn jdb -classpath DiningPhilosophers_debug/target -sourcepath DiningPhilosophers_debug/src/main/java pl.lodz.p.it.isdp.Start abc
expect ">"
send "stop at pl.lodz.p.it.isdp.Start:49\r"
expect ">"
send "run\r"
expect eof